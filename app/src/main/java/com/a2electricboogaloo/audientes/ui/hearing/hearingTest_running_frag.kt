 ...
 * [hearingtest_running_frag.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [hearingtest_running_frag.newInstance] factory method to
...
class hearingtest_running_frag : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment hearingtest_running_frag.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            hearingtest_running_frag().apply {
