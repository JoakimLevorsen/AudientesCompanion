...
class AudiogramSerializer {
    companion object {
        fun buildAudiogram(audiogram: Array<Byte>): Audiogram {
            ...
            if (audiogram[0] == AppCommands.SET_ACTIVE_AUDIOGRAM.hex) {
        ...
        fun programToByteStream(audiogram: Audiogram): Array<Byte> {
            val audiogramBase = Array(2) {0.toByte()}
            audiogramBase[0] = AppCommands.SET_ACTIVE_AUDIOGRAM.hex
